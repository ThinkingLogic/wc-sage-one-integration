...
<div class="wrap">
    ...
    <form method="post" action="options.php">
		...
		?>
        <p>You should have registered this as an application with <a
                    href="https://developerselfservice.sageone.com/user">developerselfservice.sageone.com</a> (requires
            a github login) - once registered it will provide you with the Client ID and Client Secret to enter below.
            <br/>
            When registering the application with Sage, ensure to include a callback url
            of: <?php echo $base_url . ThinkingLogicWCSage::CALLBACK_REQUEST_PATH ?>
        </p>
			...
			<?php if ( $sageone_client ) { ?>
                <tr style="vertical-align: top">
                    ...
                    <td>
                        <input type="text" name="<?php echo ThinkingLogicWCSage::OPTION_SHIPPING_TAX_ID ?>"
                               value="<?php echo esc_attr( get_option( ThinkingLogicWCSage::OPTION_SHIPPING_TAX_ID, ThinkingLogicWCSage::DEFAULT_TAX_ID ) ); ?>"/>
                        <a class="button" href="<?php echo $test_url ?>&test_endpoint=/tax_rates" ?>List Tax Rates</a>
                    </td>
                </tr>
                ...
                <tr style="vertical-align: top">
                    ...
                    <td>
                        <input type="text" name="<?php echo ThinkingLogicWCSage::OPTION_LINE_ITEM_TAX_ID ?>"
                               value="<?php echo esc_attr( get_option( ThinkingLogicWCSage::OPTION_LINE_ITEM_TAX_ID, ThinkingLogicWCSage::DEFAULT_TAX_ID ) ); ?>"/>
                    </td>
                </tr>
                ...
                <tr style="vertical-align: top">
                    ...
                    <td>
                        <input type="text" name="<?php echo Logger::OPTION_LOG_DEBUG ?>"
                               value="<?php echo esc_attr( get_option( Logger::OPTION_LOG_DEBUG, 'false' ) ); ?>"/>
                        (true|false) for debugging - only takes effect if the WP_DEBUG and WP_DEBUG_LOG constants are
                        set to true
                    </td>
                </tr>
                ...
                <tr style="vertical-align: top">
                    ...
                    <td>To obtain a refresh token and an access token, you must authenticate with Sage One and authorise
                        ...
                        <br/>
                        <input type="text" name="<?php echo ThinkingLogicWCSage::OPTION_ACCESS_TOKEN ?>"
                               value="<?php echo esc_attr( get_option( ThinkingLogicWCSage::OPTION_ACCESS_TOKEN ) ); ?>"/>
                    </td>
                </tr>
                ...
                <tr style="vertical-align: top">
                    ...
                    <td><input type="text" name="<?php echo ThinkingLogicWCSage::OPTION_ACCESS_TOKEN_EXPIRES ?>"
                        ...
                        (<?php echo gmdate( ThinkingLogicWCSage::DATE_TIME_FORMAT, get_option( ThinkingLogicWCSage::OPTION_ACCESS_TOKEN_EXPIRES ) ); ?>
                        , Time now: <?php $now = new DateTime();
						echo $now->format( ThinkingLogicWCSage::DATE_TIME_FORMAT ); ?>)
                    </td>
                </tr>
                ...
                <tr style="vertical-align: top">
                    ...
                    <td><input type="text" name="<?php echo ThinkingLogicWCSage::OPTION_REFRESH_TOKEN_EXPIRES_AT ?>"
                        ...
                        (<?php echo gmdate( ThinkingLogicWCSage::DATE_TIME_FORMAT, get_option( ThinkingLogicWCSage::OPTION_REFRESH_TOKEN_EXPIRES_AT ) ); ?>
                        , Time now: <?php $now = new DateTime();
						echo $now->format( ThinkingLogicWCSage::DATE_TIME_FORMAT ); ?>)
                    </td>
                </tr>
			...
			if ( $access_token ) {
                ...
                <tr style="vertical-align: top">
                    ...
                    <td><input type="text" name="_tl_test_endpoint" id="_tl_test_endpoint"/><a class="button"
                            ...
                            this endpoint</a> (e.g. /journals). See <a
                                href="https://developer.sage.com/api/accounting/api/">https://developer.sage.com/api/accounting/api/</a>
                    </td>
                </tr>
			<?php } ?>
